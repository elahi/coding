...
## R code 5.6
## Here I want to understand the effect of median age at marriage on marriage rate, and then use the residuals of this relationship to predict divorce rate
## Then, I could understand the effect of marriage rate on median age at marriage, and use those resids to predict divorce rate
...
head(d)
# Figure 5.4 - left panel
plot(Divorce ~ m.resid, d, col = rangi2)
abline(v = 0, lty = 2)
summary(lm(Divorce ~ m.resid, d))
